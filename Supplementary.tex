...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/Supp/InterPath_Supp_Figure_PLINK_vs2_BMI.png}
\caption[TBD]{\textbf{PLINK Results QQ-Plots}.}
\label{InterPath-Supp-Figure-PLINK-BMI}
\end{figure}
\clearpage
...
\centering
\hspace*{-.75cm}
\includegraphics[scale=.3]{Images/Supp/InterPath_Supp_Figure_MAPITvsPLINK_vs2.png}
\caption[TBD]{\textbf{MAPIT vs. PLINK Results}.}
\label{InterPath-Supp-Figure-MAPITvsPLINK}
\end{figure}
\clearpage
...
\caption[TBD]{\textbf{MAPIT-R Results: British Replicate Barplots}. The barplots show the number of genome-wide significant pathways found from running MAPIT-R for both height and BMI in the KEGG and REACTOME databases on each of our British subsample replicate populations. Genome-wide significance was determined by using Bonferroni-corrected $p$-value thresholds based on the number of pathways tested in each phenotype, replicate, and pathway database combination. Most replicate runs did not produce many significant results.}
...
\caption[TBD]{\textbf{Overlap of Genome-Wide Significant MAPIT-R Pathways Between British Replicate Subsets}. The heatplots show the numbers of genome-wide significant MAPIT-R pathways that overlap between each British replicate subset for height and BMI in the KEGG and REACTOME databases. The diagonal shows the total number of genome-wide significant pathways per population subset.}
...
\\
 ...
 & $<=$ 1000 SNPs & 9 & 26 & 34 & 577 & 4.464E-6 \\
   \hline
\end{tabular}
\caption[TBD]{\textbf{MAPIT-R Top Pathway Gene Counts: Hypergeometric Tests}}
