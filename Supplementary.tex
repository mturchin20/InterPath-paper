...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/Main/InterPath_Suppl_Figure_PLINK_vs3_BMI.png}
\caption[TBD]{\textbf{PLINK Epistasis Proportion Results: Height}. 
...
\label{InterPath-Suppl-Figure-PLINK-Proportions-BMI}
\end{figure}
