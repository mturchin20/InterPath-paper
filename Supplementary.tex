...
\begin{tabular}{|c|c|c|c|c|c|c|}
  \hline
 \textbf{Subset} & \textbf{Ancestry} & \textbf{Begin} & \textbf{iMiss} & \textbf{AfterFam} & \textbf{AfterUKB} & \textbf{AfterPCA} \\
  [2pt]\hline
