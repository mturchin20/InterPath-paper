...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.6]{Images/Supp/Greg/power_split.png}
...
\begin{figure}[htbp]
\centering
\subfigure[No Pathway Overlap]{\includegraphics[width=.45\textwidth]{Images/Supp/Greg/Rplot03.png}}
\subfigure[Pathway Overlap]{\includegraphics[width=.45\textwidth]{Images/Supp/Greg/Rplot02.png}}
