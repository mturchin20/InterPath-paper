...
\label{MAPITR-Supp-Figure-UKB-subgroups-PCAPlot}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-Simulations-part1}
\end{figure}
%\end{landscape}
\clearpage
...
\label{MAPITR-Supp-Figure-Simulations-part2}
\end{figure}
%\end{landscape}
\clearpage
...
\label{MAPITR-Supp-Figure-perm1-QQPlots-AllPaths}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-10perms-pValHists}
\end{figure}
\clearpage
...
\caption{\textbf{Heatmaps depicting the overlap of MAPIT-R significant REACTOME pathways for (a) standing height and (b) body mass index (BMI) per British replicate subgroup in the UK Biobank}. Here, the random subgroups were created by subsampling either $N =$ 4,000 or 10,000 individuals from the full British cohort. In the legend, replicates are marked as numbers after the root tag name (e.g., \texttt{Brit.Ran4k.4} denotes the fourth replicate in the $N =$ 4,000 subsampling scheme). Genome-wide significance was determined by using Bonferroni-corrected $p$-value thresholds based on the number of pathways tested in each database-phenotype-subgroup combination (see Supplementary Table \ref{MAPITR-Supp-Table-UKBPopStats}). The diagonal shows the total number of genome-wide significant pathways per subgroup. We do not observe much overlap between enriched pathways between the replicate subgroups --- even though they all consist of individuals of the same ancestry. \textcolor{red}{See Supplemental Figures \ref{MAPITR-Supp-Figure-BritReps-Barplots}-\ref{MAPITR-Supp-Figure-BritReps-Heatplots-AllPaths-KEGG},\ref{MAPITR-Supp-Figure-BritReps-perm1-QQPlots-AllPaths}-\ref{MAPITR-Supp-Figure-BritReps-10perms-pValHists-pt2} and Supplemental Tables \ref{MAPITR-Supp-Table-BritReps-FDRs-pt1}-\ref{MAPITR-Supp-Table-BritReps-FDRs-pt2} for other analyses using the 4,000 and 10,000 British replicate subgroups.}}
\label{MAPITR-Supp-Figure-BritReps-Heatplots-AllPaths-REACTOME}
\end{figure}
\clearpage
\end{landscape}
...
\textcolor{red}{See Supplemental Figures \ref{MAPITR-Supp-Figure-BritReps-Barplots}-\ref{MAPITR-Supp-Figure-BritReps-perm1-QQPlots-AllPaths},\ref{MAPITR-Supp-Figure-BritReps-10perms-pValHists-pt2} and Supplemental Tables \ref{MAPITR-Supp-Table-BritReps-FDRs-pt1}-\ref{MAPITR-Supp-Table-BritReps-FDRs-pt2} for other analyses using the 4,000 and 10,000 British replicate subgroups.}}
\label{MAPITR-Supp-Figure-BritReps-10perms-pValHists-pt1}
\end{figure}
\clearpage
%\setlength{\footskip}{1cm}
...
\label{MAPITR-Supp-Figure-pValsVsNumSNPs-perm1}
\end{figure}
\clearpage
%\setlength{\footskip}{1cm}
\end{landscape}
...
\label{MAPITR-Supp-Figure-Prot-Heatplots-African}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-Prot-Heatplots-BritRan4000}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-Prot-Heatplots-Caribbean}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-Prot-Heatplots-Chinese}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-Prot-Heatplots-Indian}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-Prot-Heatplots-Pakistani}
\end{figure}
\clearpage
...
\label{MAPITR-Supp-Figure-MAPITR-PhenoComps-AllPops}
\end{figure}
\clearpage
\setlength{\footskip}{1cm}
\end{landscape}
...
\label{MAPITR-Supp-Figure-Hypergeoemtric-SizeThresholds}
\end{figure}
\clearpage
%\setlength{\footskip}{1cm}
...
\label{MAPITR-Supp-Table-TopPathways-AllPaths-AllPhenos}
\end{table}
\clearpage
...
\label{MAPITR-Supp-Table-MAPITR-TopPathway-Overlap}
\end{table}
...
\label{MAPITR-Supp-Table-MAPITR-TopPathway-GeneCounts-Overlap}
\end{table}
...
[2pt]\hline
 ...
 \hline
\end{tabular}
\caption{\textbf{Genes that are annotated for multiple enriched pathways in both standing height and body mass index (BMI) within the African subgroup from the UK Biobank.} Here, we compare genes that are present across multiple of the pathways highlighted in blue in Figure \ref{MAPITR-Main-Figure-MAPITR-PhenoComps-African}; these are specific pathways that have more significant MAPIT-R $p$-values in BMI than in height. Genome-wide significance was determined by using Bonferroni-corrected $p$-value thresholds based on the number of pathways tested in each database-phenotype-subgroup combination with significance value $\alpha = 0.05$ (see Supplementary Table \ref{MAPITR-Supp-Table-UKBPopStats}). The second column records the number of enriched pathways that each gene belongs to, according to the KEGG database.}
\label{MAPITR-Supp-Table-MAPITR-PhenoComps-African-GeneCounts}
\end{table}
...
\multirow{10.5}{*}{\textbf{REACTOME (BMI)}} & British (4k, Rep.~1) & 6490 & 7.704$\times 10^{-5}$ & 1 & 0.015 & 4 & 0.062 & 52 & 0.801 \\
  ...
  & British (10k, Rep.~4) & 6690 & 7.474$\times 10^{-5}$ & 0 & 0.000 & 5 & 0.075 & 57 & 0.852 \\
    \hline
\end{tabular}
\caption{\textbf{MAPIT-R false discovery rates at different significance thresholds using REACTOME pathway annotations and permuted phenotypes across the British replicate subgroups in the UK Biobank.} Here, we run MAPIT-R after conducting a single random permutation of either height or body mass index (BMI) measurements. Note that traits were independently permuted within each population subgroup ten different times. The random subgroups were created by subsampling either $N$ = 4,000 or 10,000 individuals from the full British cohort. Genome-wide significance at a Bonferroni-corrected $p$-value threshold was based on the number of pathways tested in each database-phenotype-subgroup combination with significance value set to $\alpha = 0.05$. The second column lists the total number of pathways that were tested across each of the ten phenotype permutations. \# FPs denotes the number of false positives at that threshold and FDR reports the corresponding false discovery rate (listed as percentages). The remaining columns list the same information but at significance levels $\alpha = 0.001$ and 0.01, respectively. \textcolor{red}{See Supplemental Figures \ref{MAPITR-Supp-Figure-BritReps-Barplots}-\ref{MAPITR-Supp-Figure-BritReps-10perms-pValHists-pt2} and Supplemental Table \ref{MAPITR-Supp-Table-BritReps-FDRs-pt1} for other analyses using the 4,000 and 10,000 British replicate subgroups.}}
...
\label{MAPITR-Supp-Table-AllPops-TopGeneCounts-Caption}
\end{table}
...
\label{MAPITR-Supp-Table-AllPops-TopGeneCounts-SizeRestricted-Caption}
\end{table}
...
\label{MAPITR-Supp-Table-AllPops-TopGeneCount-HypergeometricTests}
\end{table}
