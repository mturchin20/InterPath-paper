...
\label{InterPath-Supp-Figure-QQPlots-KEGG}
\end{figure}
...
\label{InterPath-Supp-Figure-QQPlots-REACTOME}
\end{figure}
...
%\label{InterPath-Supp-Figure-pValHists}
%\end{figure}
...
\caption[TBD]{\textbf{TBD}. }
\label{InterPath-Supp-Figure-FDR-BritReps}
\end{figure}
