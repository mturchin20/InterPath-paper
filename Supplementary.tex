...
\textbf{Chinese:} & \\
 ...
 & KEGG\_TYPE\_I\_DIABETES\_MELLITUS \\
   \hline
\end{tabular}
\caption[TBD]{\textbf{MAPIT-R Results: UKB Subset Pathway Overlap}. Caption continued on next page. }
...
\addtocounter{table}{-1}
\begin{table} [t!]
  \caption{\textbf{MAPIT-R Results: UKB Subset Pathway Overlap}. The table shows genome-wide significant pathways that overlap between multiple UKB subsets. Specifically, pathways that overlap between the African subset and Caribbean subset, and between the African subset and Chinese subset, are listed for height results from KEGG.}
...
\begin{tabular}{cccc}
  ...
  \hline
   ...
   \hline
\end{tabular}
\caption[TBD]{\textbf{MAPIT-R Results: UKB Subset Pathway Overlap Gene Counts}. The table shows. }
\label{InterPath-Supp-Tables-MAPITR-TopPathway-Overlap-GeneCounts}
\end{table}
\clearpage
