...
\begin{tabular}{ccccc}
  \hline
  \textbf{Trait} & \textbf{Gene} & \textbf{No Restriction} & \textbf{Restricted} & \textbf{-log10($p$-Value)} \\
  ...
  & ATR & 8.004E-03 & 1.261E-03 & 0.8.02 \\
   \hline
\end{tabular}
\caption[TBD]{\textbf{MAPIT-R Genome-Wide Significant Pathway Gene Counts: Hypergeometric Enrichment Size Restricted Examples}. 
