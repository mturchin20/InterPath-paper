...
Looking at the specific pathways that we observe as having significant evidence for marginal epistasis, it does not appear that we can confidently infer population-specific examples of pathway marginal epistasis. Most genome-wide significant pathways in any non-African subset overlaps with a genome-wide significant pathway in the African subset (heatplot figure). We also observe that these genome-wide significant pathways across subsets tend to be the pathways with much larger numbers of SNPs. Interestingly, we do witness that while most populations overlap with the African subset, there is often little overlap among the non-African subsets; for example in KEGG BMI the Caribbean subset overlaps with African for 6 of its 7 pathways, and the Chinese subset overlaps with the African subset for 7 of its 8 pathways, but there is no overlap between the Chinese and Caribbean subsets.  

we observe evidence for two different patterns of results: one, more general purpose evidence of marginal epistasis  

there is some difficulty in determining whether we observe any population-specific interactions. 

It is clear that the African subset is enriched for picking up signals of pathway-level marginal epistasis as compared to the other population subsets. However, we do not currently believe this is likely to be due to African populations containing greater levels of marginal epistasis versus African populations having intrinsic genetic variation properties that better reveal marginal epistasis. For example, 

We currently lean towards this being more a factor of the genetic variation revealing 

more to be a factor of  
