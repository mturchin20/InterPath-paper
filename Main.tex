...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.225]{Images/InterPath_Main_PopCompDotPlots__African_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/InterPath_Suppl_Figure_QQPlots_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
\label{InterPath-Suppl-Figure-QQPlots}
\end{figure}
