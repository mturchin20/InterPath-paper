...
To do some intiial investigations of epistasis in European and non-European populations, we extracted four population subsets from the UKB dataset: African, Caribbean, and an Indian subset (Supplementary Table 1), as well as a random set of 4,000 British individuals. After regular QC procedures, we analyzed SNP-level epistasis using the following approaches in both height and body mass index (BMI).
...
\caption[TBD]{\textbf{TBD}. \\ See above.}
\label{InterPath-Main-Figure-Heatplots-REACTOME}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[scale=.15]{Images/InterPath_Main_PopCompDotPlots_African_vs1.png}
\caption[]{\textbf{TBD}. \\ InterPath comparisons between African and all other subsets in Height and BMI for both pathway datasets. The $x$-axis is the African -$\log_{10}$ $p$-values and $y$-axis is the row's population -$\log_{10}$ $p$-values for each pathway. Dotted red lines represent Bonferroni-corrected $p$-value thresholds for each population/phenotype/pathway-database combination.}
...
\subsection{Ambiguity in controlling for population structure in non-European populations}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/InterPath_Suppl_Figure_QQPlots_KEGG_vs1.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/InterPath_Suppl_Figure_QQPlots_REACTOME_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.15]{Images/InterPath_Suppl_pValHists_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.15]{Images/InterPath_Suppl_pValsVsNumSNPs_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.15]{Images/InterPath_Suppl_pValsVsNumSNPs_perm1_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.15]{Images/InterPath_Suppl_PhenoCompDotPlots_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
