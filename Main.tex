...
and that despite, initial gains in rebalancing these discrepancies, progress has appeared to stall (Martin2019). One question these findings lead to is why these problems still remain, if not are beginning to worsen again. Structural issues, such as biases in funding allocations and resource availability, are certainly a major contributor. Another issue may be a continued under appreciation of what investigating non-European populations can contribute to genomic analyses. Here, we want to show once again the profound, if not essential, benefit non-European populations provide in terms of novel insight into human complex trait genetic architecture.
