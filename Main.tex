...
Focusing again on the African subgroup, we observe in both the KEGG and REACTOME databases more significant pathways in BMI than height. While there is a strong correlation between the MAPIT-R -$\log_{10}$ $p$-values of these two phenotypes (.851 in KEGG and .858 in REACTOME), we consistently see more genome-wide significant pathways in BMI than height (Figure \ref{InterPath-Main-Figure-MAPITR-PhenoComps-African}). This results may align with pedigree-based heritability estimates for height and BMI, which have indicated narrow-sense heritability is around .8 in height and between .4 and .6 in BMI \citep{Elks2012,Visscher2012}; these estimates suggest that non-additive effects may play a greater role in BMI than height, which is what we observe here. 
