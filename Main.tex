...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{enumerate}
    \end{enumerate}
    \item InterPath results -- multiple populations
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Brit.Ran4k, Caribbean, Chinese, Indian, and Pakistani havea few results as well
        ...
        \end{enumerate}
        \item We find that having more SNPs tends to be correlated with having a stronger signal
        \begin{enumerate}
        ...
        \begin{enumerate}
            \item See Figure \ref{InterPath-Main-Figure-PopCompDotPlots}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.225]{Images/InterPath_Suppl_pValHists_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.225]{Images/InterPath_Suppl_PhenoCompDotPlots_vs1.png}
\caption[TBD]{\textbf{TBD}. \\ Placeholder.}
