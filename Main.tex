...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/Main/InterPath_Main_Figure_MAPIT_vs1.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=.35]{Images/Main/InterPath_Main_Figure_MAPIT_Manhattan_vs1.png}
\caption[TBD]{\textbf{MAPIT Manhattan Plot}.}
\label{InterPath-Main-Figure-MAPIT-Manhattan}
\end{figure}
