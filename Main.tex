...
Here we present both the first exploration of marginal epistasis within multiple human ancestries as well as marginal epistasis on the pathway-level. Specifically we implement a new method MAPIT-R to investigate pathway-level marginal epistasis and apply it to height and BMI across six different human ancestries (African, British, Caribbean, Chinese, Indian, and Pakistani). Using two different different pathway databases, we find a total 245 pathways that have significant interactions with the rest of the genome. We find that  the African subgroup is particularly well-powered to detect signals of pathway marginal epistasis, with this subgroup containing over 65\% of our 245 total 
genome-wide hits. We show that BMI produces more significant  across many pathways BMI produces stronger signals of marginal epistasis than height. And lastly, we find evidence that cellular signaling and immune-related pathways may be particularly enriched for marginal epistasis, and the proteasome as a protein complex may be enriched for marginal epistatic interactions as well. 
