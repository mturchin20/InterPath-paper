...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item should we still look into this? is my framing in a) the basic analysis setup we were thinking?
        \end{enumerate}
    \end{enumerate}
    \item InterPath results -- European \& non-European populations
    \begin{enumerate}
        \item See Figure \ref{InterPath-Main-Figure-Barplots}
        ...
        \end{enumerate}
        \item We show through simulations the following* (*need to discuss this!):
        \begin{enumerate}
            ...
            \item that there is unlikely to be a 'genotyping chip effect' by biasing our 'causal SNPs' based on MAF from European vs. African subsets
        ...
        \begin{enumerate}
            \item See Figures \ref{InterPath-Main-Figure-Heatplots-KEGG}, \ref{InterPath-Main-Figure-Heatplots-REACTOME} (Heatplots) \&  \ref{InterPath-Main-Figure-PopCompDotPlots} (Dotplots)
        ...
        \end{enumerate}
    \end{enumerate}
    \item InterPath results -- British replicates
    \begin{enumerate}
        ...
        \item Putting this analysis together now, but it might be good if at least the p-values are more correlated between replicates than what we see among the different ancestries previously
