...
It is well-established that genome-wide association studies (GWAS) is a powerful tool for identifying statistical associations between genetic variation and traits of interest, and indeed have identified over XX,XXX statistically significant such associations in humans alone (citations). However, it is also becoming well-established in more recent years that GWAS and GWAS-related research directions have been extraordinarily focused on European-ancestry populations.  have identified tens of thousands of genetic associations between genetic variants and various traits of interest (citations). 
