...
One other possibility is that PC space is revealing an important pattern of how population structure heterogeneity among subgroups affects MAPIT-R results, but the same PC space itself may not be sensitive enough for a pathway-level analysis. Another representation of population structure that may be more ancestry-specific, and therefore more sensitive, is local admixture ancestry estimates. 
...
(Supplementary Figure \ref{InterPath-Supp-Figure-PC1Loading-AllPaths}
