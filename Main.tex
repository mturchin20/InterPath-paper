...
Genome-wide association (GWA) studies have identified thousands of significant genetic associations in humans across a number of complex traits. However, the majority of these studies focus on linear additive relationships between genotypic and phenotypic variation. Epistasis, or non-linear genetic interactions between genotypic and phenotypic variation, is regarded as a major driver of both complex trait genetic architecture and evolution in multiple models organisms---but not in humans. A recent methodological advancement has introduced the concept of \textit{marginal epistasis}, or epistasis between a variant and the rest of the genome; identifying variants with statistically significant marginal epistatic interactions genome-wide enables computationally efficient detection of epistasis in a given complex trait. Previous approaches for detecting marginal epistasis focused only on analyzing individual variants, one at a time. Here, we present a new method, MAPIT-R, that analyzes sets of user-specific variants for the presence of marginal epistasis, and apply MAPIT-R to \red{[HOW MANY]} diverse subgroups within the UK BioBank dataset\red{: NAME THEM HERE - see SR's comment later on using self-identified group labels or some other defining covariate from UK Biobank datasets}. We tests for marginal epistasis signals underlying each of height and body mass index, and find 245 pathways within the KEGG and REACTOME databases containing statistically significant signals of marginal epistasis. 67\% of these results are detected in an African subgroup of the UKB data. We also find that BMI consistently produces stronger signals of pathway-level marginal epistasis than height. We find that the proteasome is enriched for signals of marginal epistasis and show how region-based tests such as MAPIT-R can be used to further localize association signals. And we investigate the relationship between within-subgroup genetic variation and detecting marginal epistasis.
